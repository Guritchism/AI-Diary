...
function showLoading() {
    ...
    loadingDiv.innerHTML = '<div class="chat-bubble"><span class="loader"></span> AI sedang mengetik...</div>';
    chatbox.appendChild(loadingDiv);
    chatbox.scrollTop = chatbox.scrollHeight;
}
function hideLoading() {
    let loadingDiv = document.querySelector('.chat-message.assistant.loading-indicator');
    if (loadingDiv) loadingDiv.remove();
}
// Modifikasi sendMessageToServer untuk loading
const originalSendMessageToServer = sendMessageToServer;
sendMessageToServer = function(userMessage, chatId) {
    showLoading();
    fetch('/send_message', {
        method: 'POST',
        headers: {
